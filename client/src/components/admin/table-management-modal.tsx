...
const initialTables: Table[] = [
  ...
  { id: '2', number: 2, seats: 4, status: 'occupied', currentOrder: 'ORD-001' },
  { id: '3', number: 3, seats: 6, status: 'reserved', reservedBy: 'John Doe', reservedUntil: '19:30' },
  { id: '4', number: 4, seats: 4, status: 'available' },
  { id: '5', number: 5, seats: 2, status: 'maintenance' },
